...
- `Assets/Scripts` is organized under `Systems`, `Gameplay`, `UI`, `Core`, and `Utilities`; legacy root-level duplicate runtime scripts are no longer part of the active architecture.
